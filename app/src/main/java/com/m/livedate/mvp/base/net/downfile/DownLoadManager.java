package com.m.livedate.mvp.base.net.downfile;

import android.os.Environment;
import android.util.Log;

import com.m.livedate.mvp.ApiService;
...
public class DownLoadManager {
    ...
    public void downFile(final DownModel downModel, final DownFileCallback fileCallback) {
        ...
        FileObserver observer = apiServer.dowmLoadFile(url).map(new Function<ResponseBody, String>() {
            @Override
