package com.m.livedate.bottombar;
...
public class BottomBarLayout extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private void init() {
        ...
        for (int i = 0; i < mChildCount; i++) {
            if (getChildAt(i) instanceof BottomBarItem) {
                ...
                //设置点击监听
                bottomBarItem.setOnClickListener(new MyOnClickListener(i, bottomBarItem.isCenterItem()));
            } else {
    ...
    private class MyOnClickListener implements OnClickListener {
        ...
        public MyOnClickListener(int i, boolean isCenterItem) {
            this.currentIndex = i;
            this.isCenterItem = isCenterItem;
        }
